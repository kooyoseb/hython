...
copy /y manager\setup-release\HythonManagerSetup.exe release\HythonManager-1.1.2-setup.exe >nul
echo [OK] Hython Manager Setup: release\HythonManager-1.1.2-setup.exe
