...
copy /y manager\setup-release\HythonManagerSetup.exe release\HythonManager-1.0.0-setup.exe >nul
echo [OK] Hython Manager Setup: release\HythonManager-1.0.0-setup.exe
